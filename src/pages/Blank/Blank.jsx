...
import { handleChangeAlbumABlankId,handleChangeSelectedPage } from "../../redux/reducers/blank/blankSlice";
    ...
    <>
      {Object.keys(targetAlbum).length !== 0 ? (
        <div className="blank">
            ...
            <div className="blank__meta_information">
              ...
              {(targetAlbum.data.coverData.coverSelectedType === 0 ||
                ...
                <div className="blank__meta_delivery_cover_personalisation blank__meta_info">
                  ...
                  <span>{getPersonalisation(targetAlbum.data.coverData.coverSelectedType)}</span>
                </div>
              )}
            </div>
          ...
          <PagesPreview handleChangePage={handleChangePage} size={size} pages={targetAlbum.data.pagesData.pages} justPreview selectedPage={targetAlbum.data.pagesData.selectedPage}/>
          </div>
