                  ...
                  {checkout.content[1].options[2].data.map((option, idx) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChangeDelAddress(e, option.title)
                        }
                        type={option.type}
                        placeholder={option.ph}
                        value={option.value || ""}
                 ...
                 <div key={`${album.data.mainData.albumId}:${idx}`} className="checkout__album"> 
                  <div className="checkout__album_data">
                    ...
                    <div className="checkout__album_data_preview">
                      <img src={String(BASE_URL + album.images.cover_preview)} alt="preview_img" />
                    </div>
                    <ul className="checkout__album_data_options">
                      <li>{album.data.coverData.coverSelectedType === 0 ? "Эко-кожа" : album.data.coverData.coverSelectedType === 1 ? "Ткань" : "Фотообложка"}</li>
                      <li>{album.data.pagesData.pages.length} разворотов</li>
                    </ul>
                  </div>
              ...
              <div className="checkout_content_metadata">
                ...
                {(checkout.content[1].options[0].selectedVariable === 0 ||
                  ...
                  <div className="checkout__metadata_address">
                    <div className="metadata__place">{checkout.content[1].options[1].variables[checkout.content[1].options[1].selectedVariable].transl}</div>
                    <div className="metadata__address">
                      ...
                      <div className="metadata__address_flat">Квартира: {checkout.content[1].options[2].data[3].value}</div>
                    </div>
                  </div>
                )}
              </div>
