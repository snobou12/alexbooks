...
const Basket = () => {
	...
	const handleCrementAlbumCount = (mark, albumId) => {
		...
		let newBasketAlbumMainData = {
			...prevBasketAlbumMainData,
			countOfAlbums: newCount,
		};
		let newBasketAlbumData = {
			...prevBasketAlbumData,
			mainData: newBasketAlbumMainData,
		};
								...
								<div className="basket__books_info">
									...
									<div className="basket__books_information">
										...
										<div className="basket__books_information_item basket__books_information_type">
											...
											<span>
												{basketAlbum.data.coverData.coverSelectedType === 0
													? "Эко-кожа"
													: basketAlbum.data.coverData.coverSelectedType === 1
													? "Ткань"
													: "Фотообложка"}
											</span>
										</div>
