...
import testCoverImage from "../../assets/test.jpg"
import "./Basket.scss"
const Basket = () => {
    return (
...
<div className='basket'>
            <div className="basket__uper">
                ...
                <div className="basket__title">
                    {true ? "Корзина" : "Ваша корзина пуста"}
                </div>

            </div>
            <div className="basket__books">
                {Array(10).fill(0).map((_)=>
                 <div className="basket__books_item">
                 <div className="basket__books_num">
                     1
                 </div>
                 <div className="basket__books_img">
                     <img src={testCoverImage} alt="basket_img" />
                 </div>
                 <div className="basket__books_info">
                     ...
                     <div className="basket__books_information">
                         ...
                         <div className="basket__books_information_item basket__books_information_pages">
                             ...
                             <span>10 разворотов</span>
                         </div>
                     </div>
                 </div>
                 <div className="basket__books_rightside">
                     <div className="basket__books_counter">
                         <div className="basket__books_counter_decrement">
                             -
                         </div>
                         <div className="basket__books_counter_count">
                             1
                         </div>
                         <div className="basket__books_counter_increment">
                             +
                         </div>
                     </div>
                     ...
                     <div className="basket__books_changer">
                         <div className="basket__books_changer_edit_item basket__books_changer_edit">
                             <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 x="0"
                                 y="0"
                         ...
                         <div className="basket__books_changer_edit_item basket__books_changer_delete">
                             <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 x="0"
                                 y="0"
        ...
        <div className="basket__submit">
                <div className="basket__submit_wrapper">
                    ...
                    <div className="basket__submit_promo">
                        ...
                        <div className="basket__submit_promo_row">
                            ...
                            >
                                ...
                                <circle cx="17.5" cy="17.5" r="17.5" fill="url(#paint0_linear)"></circle>
                                <path
                                    stroke="#fff"
                                    strokeLinecap="round"
                    ...
                    <div className="basket__submit_fin">
                        итого <span>45400 руб.</span>
                        <a href="/checkout" className="basken__submit_btn">Заказать</a>
                    </div>
                </div>
            </div>
        </div>
